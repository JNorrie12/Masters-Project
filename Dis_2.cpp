...
// const int L1=8, genomes1=256 , L2=8, genomes2=256, No=2000, K=1, generations = 10000;
// const double theta = 1, pmut = 0.01, pkill = 0.3, c = 40, mu = 0.007;

const int L1=8, genomes1=256 , L2=8, genomes2=256, No=2000, K=1, generations = 10000;
const double theta = 0.25, pmut = 0.026, pkill = 0.2, c = 40, mu = 0.001;
    ...
    while( count_gen < generations){
        ...
        if(step == tau){
            ...
            for (int i=0; i < genomes1; i++){
				...
				for (int j=genomes1; j< genomes; j++){
                N2 += species[j];
			}
            if(N1==0 || N2==0){
